...
[attribution contract](./mokabook-component-changes.md).
...
Mokabook never fingerprints a callback's source or a function's identity.
...
`mokabookInstance` is reserved for the wrapper, stripped before calling the
